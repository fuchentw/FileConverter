...
namespace FileConverter
{
    ...
    public static class Helpers
    {
        public static readonly string[] CompatibleInputExtensions = {
            "3gp","3gpp","aac","aiff","ape","arw","avi","avif","bik","bmp","cda","cr2","csv","dds","dng","doc","docx",
            "eml","epub","exr","flac","flv","gif","heic","htm","html","ico","ipynb","jfif","jpg","jpeg","json","m4a","m4b","m4v","mkv","mov","mp3","mp4",
            "mpg","mpeg","msg","nef","odp","ods","odt","oga","ogg","ogv","opus","pdf","png","ppt","pptx","psd",
            "raf", "rm","svg","tga","tif","tiff", "ts", "vob","wav","webm","webp","wma","wmv","xls","xlsx","xml"
        };
