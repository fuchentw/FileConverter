...
namespace FileConverter
{
    ...
    public static class PathHelpers
    {
        ...
        {
            return GenerateFilePathFromTemplate(inputFilePath, outputFileExtension.ToString().ToLowerInvariant(), outputFilePathTemplate, numberIndex, numberMax);
        }

        public static string GenerateFilePathFromTemplate(string inputFilePath, string outputExtension, string outputFilePathTemplate, int numberIndex, int numberMax)
        {
            ...
            outputExtension = (outputExtension ?? string.Empty).ToLowerInvariant().TrimStart('.');
