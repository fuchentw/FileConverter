    ...
    public partial class Application : System.Windows.Application
    {
        static Application()
        {
            AppDomain.CurrentDomain.AssemblyResolve += (sender, args) =>
            {
                ...
                {
                    string culture = requestedAssembly.CultureInfo?.Name;
                    if (string.IsNullOrEmpty(culture))
                    {
                        ...
                        foreach (var part in parts)
                        {
                            ...
                            if (trimmed.StartsWith("Culture=", StringComparison.OrdinalIgnoreCase))
                            {
                                culture = trimmed.Substring("Culture=".Length);
                                break;
                            }
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(culture) && !string.Equals(culture, "neutral", StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        string assemblyPath = Path.Combine(baseDir, "Languages", culture, $"{requestedAssembly.Name}.dll");
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            if (settingsService.Settings?.ApplicationLanguage != null)
            {
                var lang = settingsService.Settings.ApplicationLanguage;
                Thread.CurrentThread.CurrentCulture = lang;
                Thread.CurrentThread.CurrentUICulture = lang;
                System.Globalization.CultureInfo.DefaultThreadCurrentCulture = lang;
                System.Globalization.CultureInfo.DefaultThreadCurrentUICulture = lang;
                FileConverter.Properties.Resources.Culture = lang;
            }
