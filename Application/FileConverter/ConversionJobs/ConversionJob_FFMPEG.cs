...
namespace FileConverter.ConversionJobs
{
    ...
    public partial class ConversionJob_FFMPEG : ConversionJob
    {
        ...
        protected virtual string FfmpegPath
        {
            get
            {
                if (!string.IsNullOrWhiteSpace(this.ConversionPreset?.CustomExecutablePath))
                {
                    string customPath = System.Environment.ExpandEnvironmentVariables(this.ConversionPreset.CustomExecutablePath);
                ...
                case OutputType.Mp4:
                    {
                        ...
                        Helpers.HardwareAccelerationMode hwAccel = this.SettingsService?.Settings?.HardwareAccelerationMode ?? Helpers.HardwareAccelerationMode.Off;
