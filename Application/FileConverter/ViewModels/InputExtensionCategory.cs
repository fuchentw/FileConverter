...
namespace FileConverter.ViewModels
{
    ...
    {
        private readonly ObservableCollection<InputExtension> inputExtensions = new ObservableCollection<InputExtension>();
        private string name;
        ...
        public ObservableCollection<InputExtension> InputExtensions => this.inputExtensions;
        ...
        public void AddExtension(string extension, bool isCustom = false)
        {
            InputExtension inputExtension = this.inputExtensions.FirstOrDefault(match => match.Name == extension);
            if (inputExtension == null)
            {
                inputExtension = new InputExtension(extension, isCustom);
        ...
        public void RemoveExtension(string extension)
        {
            ...
            {
                inputExtension.PropertyChanged -= this.OnExtensionPropertyChange;
                this.inputExtensions.Remove(inputExtension);
